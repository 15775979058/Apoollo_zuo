...
#ifndef MODULES_PERCEPTION_OBSTACLE_ONBORAD_CAMERA_PROCESS_FRONTRIGHT_SUBNODE_H_
#define MODULES_PERCEPTION_OBSTACLE_ONBORAD_CAMERA_PROCESS_FRONTRIGHT_SUBNODE_H_
...
class CameraProcessFrontRightSubnode : public Subnode {
 public:
  CameraProcessFrontRightSubnode() = default;
  ~CameraProcessFrontRightSubnode() = default;
...
REGISTER_SUBNODE(CameraProcessFrontRightSubnode);

}  // namespace perception
}  // namespace apollo

#endif  // MODULES_PERCEPTION_OBSTACLE_ONBORAD_CAMERA_PROCESS_FRONTRIGHT_SUBNODE_H_
